    ...
    'settings'   => [
        'general'          => [
            ...
            'fields' => [
                ...
                'hide_label'             => [
                    'type'  => 'checkbox',
                    'title' => Text::_('COM_SPPAGEBUILDER_ADDON_FORM_BUILDER_HIDE_LABEL'),
                    'desc'  => Text::_('COM_SPPAGEBUILDER_ADDON_FORM_BUILDER_HIDE_LABEL_DESC'),
                    'std'   => 0,
                ],
        ...
        'security_options' => [
            'title'  => Text::_('COM_SPPAGEBUILDER_ADDON_SECURITY_OPTIONS'),
            'desc'   => Text::_('COM_SPPAGEBUILDER_ADDON_SECURITY_OPTIONS_DESC'),
            'fields' => [
                'enable_rate_limit' => [
                    'type'   => 'checkbox',
                    'title'  => Text::_('COM_SPPAGEBUILDER_ADDON_ENABLE_RATE_LIMIT'),
                    'desc'   => Text::_('COM_SPPAGEBUILDER_ADDON_ENABLE_RATE_LIMIT_DESC'),
                    'values' => [
                        '0' => 'No',
                        '1' => 'Yes',
                    ],
                ...
                'max_requests'      => [
                    'type'    => 'number',
                    'title'   => Text::_('COM_SPPAGEBUILDER_ADDON_MAX_REQUESTS'),
                    'desc'    => Text::_('COM_SPPAGEBUILDER_ADDON_MAX_REQUESTS_DESC'),
                    'std'     => 10,
                    'placeholder' => Text::_('COM_SPPAGEBUILDER_ADDON_SET_MAX_REQUESTS'),
                    'depends' => ['enable_rate_limit' => '1'],
                ],
                'time_window'       => [
                    'type'    => 'number',
                    'title'   => Text::_('COM_SPPAGEBUILDER_ADDON_TIME_WINDOW'),
                    'desc'    => Text::_('COM_SPPAGEBUILDER_ADDON_TIME_WINDOW_DESC'),
                    'std'     => 60,
                    'placeholder' => Text::_('COM_SPPAGEBUILDER_ADDON_SET_TIME_WINDOW'),
                    'depends' => ['enable_rate_limit' => '1'],
                ],
            ],
        ],
